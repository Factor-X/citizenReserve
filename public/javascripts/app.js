...
householdResolveUnsecure.instanceName = function() {
  return 'household';
};
enterpriseResolveUnsecure = angular.extend({}, changeLanguageResolve);
enterpriseResolveUnsecure.instanceName = function() {
  return 'enterprise';
};
authorityResolveUnsecure = angular.extend({}, changeLanguageResolve);
authorityResolveUnsecure.instanceName = function() {
  return 'authority';
};
  ...
  $scope.validation = {
    ...
    powerConsumption: {
      valid: function() {
        ...
        return !isNaN(Number(powerConsumption)) && (Number(powerConsumption) >= 0);
      }
    },
    terms: {
