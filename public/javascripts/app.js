...
angular.module('app').run(function(surveyDTOService) {
  return surveyDTOService.initialize();
});
...
angular.module('app.controllers').config(function($routeProvider) {
  ...
  this.getAnswerValue = function(questionKey, periodKey) {
    ...
    answer = _.findWhere(surveyDTO.answers, {
