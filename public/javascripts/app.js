...
});angular.module('app.controllers').controller("MainCtrl", function($scope, translationService, modalService, $log) {
  $scope.initialLoad = {
    translations: false
  };
...
angular.module('app').run(function($rootScope, $location, translationService) {});angular.module('app.controllers').controller("NiceModalCtrl", function($scope, $modalInstance, chosenValue) {
