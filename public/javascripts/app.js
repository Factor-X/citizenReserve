...
});angular.module('app.controllers').controller("WelcomeCtrl", function($scope, modalService, $log, $location) {});angular.module('app.controllers').controller("FormCtrl", function($scope, modalService, $log, topic) {
  $scope.topic = topic;
  $scope.slider = {
    schedule: {
      value: null,
