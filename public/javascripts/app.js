...
Messenger.options = {
  ...
  var resetAnswerValues, testAnswerEquals, testAnswerIsGreaterThan, testAnswerIsLowerThan, testAnswerIsTrue, testAnswerNotEquals, testAnyAnswerNotEquals, testIsNotAlwaysOut, tests, tooltips;
  ...
  return {
    ...
    link: function(scope, elem, attrs, ngModel) {
      ...
      questionKey = o.key;
      periodKey = o.period;
      if (conditionService.getTooltip(questionKey) != null) {
