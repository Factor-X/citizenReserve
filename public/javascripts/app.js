...
angular.module('app.controllers').config(function($routeProvider) {
  ...
  var hits, resetAnswerValues, svc, testAnswerIsGreaterThan, testAnswerIsTrue, testAnswerNotEquals, testAnyAnswerNotEquals, testIsNotAlwaysOut, tests;
  svc = this;
  hits = 0;
