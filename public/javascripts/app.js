...
angular.module('app').run(function($rootScope, $location) {
...
});angular.module('app.controllers').controller("RegistrationCtrl", function($scope, modalService, $log, downloadService, surveyDTOService, $modalInstance, optionService) {
  ...
  return $scope.checkValidity = function() {
