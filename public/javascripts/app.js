...
});angular.module('app.directives').directive("crContinuousSlider", function(directiveService) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngLabel: '=',
    ...
    templateUrl: "$/angular/templates/cr-continuous-slider.html",
    replace: true,
    link: function(scope, elem, attrs, ngModel) {
      directiveService.autoScopeImpl(scope);
      scope.setValue = function(v) {
