...
angular.module('app.controllers').config(function($routeProvider) {
  $routeProvider.when('/household-profile/:topic', {
    templateUrl: '$/angular/views/profile/household-profile.html',
    controller: 'FormCtrl',
    resolve: {
    ...
    templateUrl: '$/angular/views/action/household-action.html',
    controller: 'FormCtrl',
    resolve: {
      topic: function($route) {
        return $route.current.params.topic;
...
>>>>>>> 3fbead3a4c361fe198f8c06951daca79a9901ac8
