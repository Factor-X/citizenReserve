...
});angular.module('app.directives').directive("crTopic", function(directiveService) {
  return {
    restrict: "E",
    scope: directiveService.autoScope,
