...
});angular.module('app.controllers').controller("RegistrationCtrl", function($scope, modalService, $log, topic, downloadService, surveyDTOService, conditionService, $location) {
  $scope.o = {
    errorMessage: "",
    repeatPassword: "",
