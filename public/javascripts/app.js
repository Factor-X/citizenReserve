...
});angular.module('app.controllers').controller("DirectivesDemoCtrl", function($scope, modalService, $log, gettextCatalog) {
  $scope.setLanguage = function(lang) {
    return gettextCatalog.setCurrentLanguage(lang);
  };
  $scope.x = {
