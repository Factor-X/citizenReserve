...
>>>>>>> 549cdcf74ca7f46e22152df7ec4123fec8f10f04
  };
  return;
...
=======
  ...
  return this.checkCondition = function(s) {};
});angular.module('app.services').service("generateId", function($rootScope) {
  this.generate = function() {
    var i, possible, text;
    text = "";
