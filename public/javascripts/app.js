...
Messenger.options = {
  ...
  var getNumericValue, resetAnswerValues, testAnswerEquals, testAnswerIsFalse, testAnswerIsGreaterThan, testAnswerIsLowerThan, testAnswerIsTrue, testAnswerNotEquals, testAnswerNotNull, testAnyAnswerNotEquals, testIsNotAlwaysOut, tests, tooltips;
  ...
  tests = {
    ...
    Q3720: function() {
      return testIsNotAlwaysOut() && ((testAnyAnswerNotEquals("Q1140", "0") && testAnswerNotEquals("Q3711", null, "4")) || testAnswerIsFalse("Q3710"));
    },
    Q3730: function() {
      return testIsNotAlwaysOut() && ((testAnyAnswerNotEquals("Q1150", "0") && testAnswerNotEquals("Q3711", null, "4")) || testAnswerIsFalse("Q3710"));
    },
    Q3750: function() {
      return testIsNotAlwaysOut() && ((testAnswerNotEquals("Q2030", null, "0") && testAnswerNotEquals("Q3711", null, "4")) || testAnswerIsFalse("Q3710"));
    },
    Q3760: function() {
      return testIsNotAlwaysOut() && ((testAnswerNotEquals("Q2040", null, "0") && testAnswerNotEquals("Q3711", null, "4")) || testAnswerIsFalse("Q3710"));
    },
    Q3740: function() {
      return testIsNotAlwaysOut() && (testAnswerNotEquals("Q3711", null, "4") || testAnswerIsFalse("Q3710"));
    },
    Q3741: function() {
  ...
  this.createPreAccount = function(accountType, lang) {
    this.surveyDTO.account.accountType = accountType;
...
});angular.module('app.directives').directive("crLogin", function(surveyDTOService, downloadService, $state) {
  return {
    restrict: "E",
    scope: {},
...
});angular.module('app.controllers').controller("RegistrationCtrl", function($scope, modalService, $log, downloadService, surveyDTOService, optionService, $state, $flash) {
    ...
    return downloadService.postJson('/reduction/potential', surveyDTOService.surveyDTO, function(result) {
      if (result.success) {
        ...
        if (!!$scope.potentialReduction) {
          return $scope.potentialAveragePowerReduction = $filter("number")(parseFloat($scope.potentialReduction.averagePowerReduction), 0);
        }
      } else {
    ...
    return downloadService.postJson('/reduction/effective', surveyDTOService.surveyDTO, function(result) {
      if (result.success) {
        ...
        if (!!$scope.effectiveReduction) {
          return $scope.effectiveAverageReduction = $filter("number")(parseFloat($scope.effectiveReduction.reductions[0].averagePowerReduction), 0);
        }
      } else {
        return console.log(result.data);
      }
  ...
  $scope.data = [];
  downloadService.getJson('/batch/last', function(result) {
  ...
  $scope.getSummaryResult = function() {
    return downloadService.getJson('/stats/summaryValues', function(result) {
      ...
      if (result.success) {
        ...
        if (!!summaryResult) {
          return $scope.totalEffectiveAverageReduction = $filter("number")(parseFloat(summaryResult.effectiveReduction) / 1000, 0);
        }
      } else {
        return console.log(result.data);
      }
