...
angular.module('app.directives', ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ui-rangeSlider', 'nvd3', 'ui.bootstrap.datetimepicker']);
...
Messenger.options = {
  ...
  return {
    ...
    link: function(scope, element, attrs, controller) {
      ...
      formatter = function(viewValue) {
        var momentValue, result;
        result = null;
        if (viewValue != null) {
      ...
      return controller.$formatters.push(formatter);
    }
  };
...
});angular.module('app.directives').directive("crEnterpriseForm", function(directiveService) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngQuestions: '=',
