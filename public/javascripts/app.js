...
});angular.module('app.directives').directive("crDouble", function() {
  return {
    restrict: "E",
    scope: {
      ngModel: '=',
    ...
    link: function(scope, elem, attrs, ctrl) {
      return scope.$watch('ngModel', function(newValue, oldValue) {
        ...
        if (typeof newValue === 'string') {
          ...
          if (isNaN(newValue)) {
            return scope.ngModel = oldValue;
          } else {
            return scope.ngModel = parseFloat(newValue);
          }
        }
      });
    }
