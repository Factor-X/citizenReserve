...
<<<<<<< HEAD
  ...
  return;
=======
>>>>>>> 8fd65102d04f732d0634b05276c1f0fac67b46ad
...
<<<<<<< HEAD
*/angular.module('app.controllers').controller("WelcomeCtrl", function($scope, modalService, $log, $location) {});angular.module('app.controllers').controller("MainCtrl", function($scope, modalService, $log, gettextCatalog) {
=======
*/angular.module('app.controllers').controller("ModalTopicCtrl", function($scope, surveyDTOService, optionService) {
  ...
  return $scope.getAnswerValue = function(questionKey, periodKey) {
