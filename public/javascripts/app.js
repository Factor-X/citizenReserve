...
});angular.module('app.controllers').controller("EnterpriseResultsCtrl", function($scope, modalService, $filter, $timeout, $log, downloadService, surveyDTOService) {
  $scope.isAuthenticated = function() {
    return surveyDTOService.isAuthenticated();
  };
